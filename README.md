...
- [Certification, market and adjudication pass](scratch/market-and-certification/README.md) — 2026-09-11: closes two of the [2026-09-04 sweep](VERIFICATION-sweep-2026-09-04.md) §6 gaps and **overturns its Xteink certification finding**. 26 FCC filings, 174 exhibits, with positive and negative controls.
- [Schematic net-tracing pass](scratch/schematic-tracing/README.md) — 2026-09-11: **291 schematic PDFs assessed**, five boards fully traced from PDF alone; per-file verdicts in [`traceability-census.md`](scratch/schematic-tracing/traceability-census.md).

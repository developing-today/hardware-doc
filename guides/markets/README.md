...
| [**Handheld and e-ink device landscape, 2026-09**](handheld-and-eink-device-landscape-2026-09.md) | Every device record in this library, grouped the way somebody actually shops: **pocket e-ink readers** (Xteink X3/X4/X4 Pro/X4 Classic, M5Stack PaperMono and PaperMono Lite, ZeroWriter Ink/Fold, Waveshare ESP32-S3-ePaper-3.97), **keyboard handhelds** (Cardputer v1.1 and ADV, LilyGO T-Display K230 Kit, Tanmatsu), **display dev boards** (the LilyGO T-Display-S3 family, the Waveshare knob board, XIAO ESP32S3 Sense) and **LoRa/mesh add-ons** (Cap LoRa-1262, Cap LoRa868, Cap CC1101, Unit C6L, Stamp-C6LoRa, the E220 and STM32WLE5 units). Like-for-like tables **with dated prices**, then prose on who should buy which — and explicit statements of where the evidence does not support a comparison. Complements the per-feature [device comparison matrix](device-comparison-matrix.md). *Added 2026-09-07* |
...
> **Scope correction, 2026-09-07.** Point 1 above describes the three guides written in the
> 2026-08-24 pass and is still accurate for them. It does **not** apply to
> [handheld-and-eink-device-landscape-2026-09.md](handheld-and-eink-device-landscape-2026-09.md),
> which carries **dated, sourced observed prices** gathered in the 2026-09-04/07 pass, each with
> seller, date, region and configuration in the format `vendor-comparison.md` prescribes. Read
> that guide's own evidence-boundary section for its sampling limits — in particular that no
> marketplace or used-market sampling was done for most devices.

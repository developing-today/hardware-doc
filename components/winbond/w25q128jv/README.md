...
- **[LilyGO T-Display-S3 family](../../../devices/lilygo/t-display-s3-shared/README.md)** — designator `U3` on the [T-Display-S3](../../../devices/lilygo/t-display-s3/README.md) (part string `W25Q128JV` on `T_Display_S3.pdf` @ `ec889e7`), and likewise on the [AMOLED](../../../devices/lilygo/t-display-s3-amoled/README.md) V2.0 sheet, [AMOLED Plus](../../../devices/lilygo/t-display-s3-amoled-plus/README.md), [Long](../../../devices/lilygo/t-display-s3-long/README.md), [Pro](../../../devices/lilygo/t-display-s3-pro/README.md), [T4-S3](../../../devices/lilygo/t4-s3/README.md) and [AMOLED Lite](../../../devices/lilygo/t-display-amoled-lite/README.md). QIO at 80 MHz; PlatformIO board manifest declares `memory_type qio_opi`, `flash_size 16MB`, `partitions default_16MB.csv`. **Note the conflict:** the *older* 1.91″ AMOLED schematic shows a **`W25Q32`** (4 MB) in the same position while every LilyGO README and store listing says 16 MB — see [that board's gaps](../../../devices/lilygo/t-display-s3-amoled/gaps-and-conflicts.md). Verify with `esptool.py flash_id` before relying on 16 MB.

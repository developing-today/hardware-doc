...
- [LilyGO T-Display-S3 Touch](../../../devices/lilygo/t-display-s3-touch/README.md) — **CST816S**, the touch controller of *early* production of LilyGO's 1.9″ 170×320 board. I²C `0x15` on GPIO17 (SCL) / GPIO18 (SDA), on-board 10 kΩ pull-ups, `INT` GPIO16, `RST` GPIO21. Selected in software with `-DTOUCH_MODULES_CST_SELF`. **Later production substitutes the mutual-capacitance [CST328](../cst328/README.md) at `0x1A`** without renaming the product — see [board-revision-drift R1](../../../devices/lilygo/t-display-s3-shared/board-revision-drift.md#r1--t-display-s3-touch-cst816s--cst328). The controller sits on the panel flex and is powered from the board's GPIO15-gated rail, so an I²C scan with GPIO15 low finds nothing.
- [LilyGO T-Display-S3 AMOLED](../../../devices/lilygo/t-display-s3-amoled/README.md) — a CST816-family part is the touch controller on the Touch SKUs of the 1.91″ AMOLED board. LilyGO mirrors `CST816_Register.pdf` in `LilyGo-AMOLED-Series`; retained here as [`artifacts/cst816-register-en-lilygo-mirror.pdf`](artifacts/cst816-register-en-lilygo-mirror.pdf) (66 813 B, SHA-256 `696d3517c7c21ea575f4cd63b6debc20727b74ef1b5188ecdf23bec6b5867b43`), alongside the CST816S Chinese register guide LilyGO ships in the T-Display-S3 repo, [`artifacts/cst816s-register-guide-cn-20190508-lilygo-mirror.pdf`](artifacts/cst816s-register-guide-cn-20190508-lilygo-mirror.pdf) (76 816 B, SHA-256 `c39871756afd65fb043bb262f6cf9d0c8e1d2526ecc521ffa8f6b56345ff7643`). Both retrieved 2026-09-07.

# ARCHIVED: `2AC7Z-ESPS3WROOM1-external-photos-5637981.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — external photos, 332,733 B (0.32 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-external-photos-5637981.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-external-photos-5637981.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 332,733 B (0.32 MiB) |
| SHA-256 | `b04d392ae5298711cec05f57970745731dcaec0c05016a8ed9c68ad8cff0d848` |
| FCC ID | **`2AC7Z-ESPS3WROOM1`** |
| Exhibit type | **External Photos** |
| Exhibit title, as filed | External photos |
| FCC document id | 5637981 |
| Upstream publication date | 2022-07-21 |
...
- <https://fccid.io/2AC7Z-ESPS3WROOM1/External-Photos/External-photos-5637981.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=5637981>  
...
- <https://fcc.report/FCC-ID/2AC7Z-ESPS3WROOM1/5637981.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2AC7Z-ESPS3WROOM1/External-Photos/External-photos-5637981.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-external-photos-5637981.pdf" \
   "components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-external-photos-5637981.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2AC7Z-ESPS3WROOM1/External-Photos/External-photos-5637981.pdf" -o "2AC7Z-ESPS3WROOM1-external-photos-5637981.pdf"
echo "b04d392ae5298711cec05f57970745731dcaec0c05016a8ed9c68ad8cff0d848  2AC7Z-ESPS3WROOM1-external-photos-5637981.pdf" | sha256sum -c -
```

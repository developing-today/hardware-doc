# ARCHIVED: `2AC7Z-ESPS3WROOM1-sar-report-b.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — rf exposure info, 850,218 B (0.81 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-sar-report-b.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-sar-report-b.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 850,218 B (0.81 MiB) |
| SHA-256 | `62b4f82db50809aa91a1f0e80e878982838cac07880d865a6578d78d0462f942` |
| FCC ID | **`2AC7Z-ESPS3WROOM1`** |
| Exhibit type | **RF Exposure Info** |
| Exhibit title, as filed | SAR Report B |
| FCC document id | 9104675 |
...
- <https://fccid.io/2AC7Z-ESPS3WROOM1/RF-Exposure-Info/SAR-Report-B-9104675.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=9104675>  
...
- <https://fcc.report/FCC-ID/2AC7Z-ESPS3WROOM1/9104675.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2AC7Z-ESPS3WROOM1/RF-Exposure-Info/SAR-Report-B-9104675.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-sar-report-b.pdf" \
   "components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-sar-report-b.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2AC7Z-ESPS3WROOM1/RF-Exposure-Info/SAR-Report-B-9104675.pdf" -o "2AC7Z-ESPS3WROOM1-sar-report-b.pdf"
echo "62b4f82db50809aa91a1f0e80e878982838cac07880d865a6578d78d0462f942  2AC7Z-ESPS3WROOM1-sar-report-b.pdf" | sha256sum -c -
```

# ARCHIVED: `2AC7Z-ESPS3WROOM1-sar-report-c1.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — rf exposure info, 5,908,102 B (5.63 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-sar-report-c1.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-sar-report-c1.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 5,908,102 B (5.63 MiB) |
| SHA-256 | `8fbf6c55dc6a02487d8290108deb6471b45aa58d3bfe2b55a855af7256d063c7` |
| FCC ID | **`2AC7Z-ESPS3WROOM1`** |
| Exhibit type | **RF Exposure Info** |
| Exhibit title, as filed | SAR Report C1 |
| FCC document id | 9104676 |
...
- <https://fccid.io/2AC7Z-ESPS3WROOM1/RF-Exposure-Info/SAR-Report-C1-9104676.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=9104676>  
...
- <https://fcc.report/FCC-ID/2AC7Z-ESPS3WROOM1/9104676.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2AC7Z-ESPS3WROOM1/RF-Exposure-Info/SAR-Report-C1-9104676.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-sar-report-c1.pdf" \
   "components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-sar-report-c1.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2AC7Z-ESPS3WROOM1/RF-Exposure-Info/SAR-Report-C1-9104676.pdf" -o "2AC7Z-ESPS3WROOM1-sar-report-c1.pdf"
echo "8fbf6c55dc6a02487d8290108deb6471b45aa58d3bfe2b55a855af7256d063c7  2AC7Z-ESPS3WROOM1-sar-report-c1.pdf" | sha256sum -c -
```

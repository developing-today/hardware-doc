# ARCHIVED: `2AC7Z-ESPS3WROOM1-rf-exposure.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — rf exposure info, 499,298 B (0.48 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-rf-exposure.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-rf-exposure.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 499,298 B (0.48 MiB) |
| SHA-256 | `b1ae557e1e78bbfa0ff2a20a8077103a8cb6c7c63760db0a63b187806fcf3d40` |
| FCC ID | **`2AC7Z-ESPS3WROOM1`** |
| Exhibit type | **RF Exposure Info** |
| Exhibit title, as filed | RF Exposure |
| FCC document id | 6102621 |
...
- <https://fccid.io/2AC7Z-ESPS3WROOM1/RF-Exposure-Info/RF-Exposure-6102621.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=6102621>  
...
- <https://fcc.report/FCC-ID/2AC7Z-ESPS3WROOM1/6102621.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2AC7Z-ESPS3WROOM1/RF-Exposure-Info/RF-Exposure-6102621.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-rf-exposure.pdf" \
   "components/espressif/esp32-s3-wroom-1/artifacts/certification/2AC7Z-ESPS3WROOM1-rf-exposure.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2AC7Z-ESPS3WROOM1/RF-Exposure-Info/RF-Exposure-6102621.pdf" -o "2AC7Z-ESPS3WROOM1-rf-exposure.pdf"
echo "b1ae557e1e78bbfa0ff2a20a8077103a8cb6c7c63760db0a63b187806fcf3d40  2AC7Z-ESPS3WROOM1-rf-exposure.pdf" | sha256sum -c -
```

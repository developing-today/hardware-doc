# ARCHIVED: `2AN3WM5STAMPS3A-fcc-rf-exposure-mpe-20cm.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — rf exposure info, 176,710 B (0.17 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `components/m5stack/stamp-s3a/artifacts/certification/2AN3WM5STAMPS3A-fcc-rf-exposure-mpe-20cm.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/components/m5stack/stamp-s3a/artifacts/certification/2AN3WM5STAMPS3A-fcc-rf-exposure-mpe-20cm.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 176,710 B (0.17 MiB) |
| SHA-256 | `db49d95ade5911cc7a0d60ebd93a084c7dd4ef2187ba2b48a33e3d5a1387833c` |
| FCC ID | **`2AN3WM5STAMPS3A`** |
| Exhibit type | **RF Exposure Info** |
| Exhibit title, as filed | FCC RF Exposure-MPE (20cm) |
| FCC document id | 8045273 |
...
- <https://fccid.io/2AN3WM5STAMPS3A/RF-Exposure-Info/FCC-RF-Exposure-MPE-20cm-8045273.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=8045273>  
...
- <https://fcc.report/FCC-ID/2AN3WM5STAMPS3A/8045273.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2AN3WM5STAMPS3A/RF-Exposure-Info/FCC-RF-Exposure-MPE-20cm-8045273.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/components/m5stack/stamp-s3a/artifacts/certification/2AN3WM5STAMPS3A-fcc-rf-exposure-mpe-20cm.pdf" \
   "components/m5stack/stamp-s3a/artifacts/certification/2AN3WM5STAMPS3A-fcc-rf-exposure-mpe-20cm.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2AN3WM5STAMPS3A/RF-Exposure-Info/FCC-RF-Exposure-MPE-20cm-8045273.pdf" -o "2AN3WM5STAMPS3A-fcc-rf-exposure-mpe-20cm.pdf"
echo "db49d95ade5911cc7a0d60ebd93a084c7dd4ef2187ba2b48a33e3d5a1387833c  2AN3WM5STAMPS3A-fcc-rf-exposure-mpe-20cm.pdf" | sha256sum -c -
```

...
Anything that is *not* family-wide remains in this directory — driver bundles, install notes, the
VID/PID table, and the CH343/CH9102 datasheets used for candidate elimination.

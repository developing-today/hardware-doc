...
- <https://fccid.io/2BTR9-X4L/RF-Exposure-Info/RF-Exposure-Report-9556503.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=9556503>  
...
- <https://fcc.report/FCC-ID/2BTR9-X4L/9556503.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2BTR9-X4L/RF-Exposure-Info/RF-Exposure-Report-9556503.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/devices/xteink/x4-light/artifacts/certification/2BTR9-X4L-rf-exposure-report.pdf" \
   "devices/xteink/x4-light/artifacts/certification/2BTR9-X4L-rf-exposure-report.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2BTR9-X4L/RF-Exposure-Info/RF-Exposure-Report-9556503.pdf" -o "2BTR9-X4L-rf-exposure-report.pdf"
echo "b9cb6b076a72956e1d0b037e16208dd0f81f26da193a77e55b5d5369ff74d75b  2BTR9-X4L-rf-exposure-report.pdf" | sha256sum -c -
```

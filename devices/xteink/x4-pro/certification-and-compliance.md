# Certification and compliance — x4-pro
...
**FCC: granted.** `2BTR9-X4PRO`, 2026-06-16.

| Regime | Status |
|---|---|
| **FCC (US)** | ✅ `2BTR9-X4PRO` — granted **2026-06-16** |
...
| Exhibit rows | 12 |
| Filing page | <https://fccid.io/2BTR9-X4PRO> — HTTP 200, retrieved 2026-09-11 |

**Withheld:**

- User Manual [Users Manual 2026-12-12]
- Internal Photos [Internal Photos 2026-12-12]
- Test Setup Photos [Test Setup Photos 2026-12-12]
- BLOCK [Block Diagram]
- SCH [Schematics]
...
|---|---:|---|---|
| [`2BTR9-X4PRO-external-photos.pdf`](artifacts/certification/2BTR9-X4PRO-external-photos.pdf) | 5,317,690 | `2565de437321171cdae9b81fefa061ec…` | External Photos |
...
|---|---:|---|
| [`2BTR9-X4PRO-rf-exposure-report.pdf.ARCHIVED.md`](artifacts/certification/2BTR9-X4PRO-rf-exposure-report.pdf.ARCHIVED.md) | 148,234 | RF Exposure Info |
...
|---|---|---|---|---|---|---|---|
| XC-1 | FCC ID `2BTR9-X4PRO` record | US FCC via fccid.io | **primary (regulatory)**, via mirror | regulatory record | <https://fccid.io/2BTR9-X4PRO> | 2026-09-11 | Grant existence, date, frequencies, exhibit list, embargo dates |

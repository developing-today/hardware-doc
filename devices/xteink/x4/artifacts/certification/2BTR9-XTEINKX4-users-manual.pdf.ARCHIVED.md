# ARCHIVED: `2BTR9-XTEINKX4-users-manual.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — users manual, 1,417,715 B (1.35 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `devices/xteink/x4/artifacts/certification/2BTR9-XTEINKX4-users-manual.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/devices/xteink/x4/artifacts/certification/2BTR9-XTEINKX4-users-manual.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 1,417,715 B (1.35 MiB) |
| SHA-256 | `7329a83131ad1ed913833316b6225415feee97392fabb240913db69e81b0c100` |
| FCC ID | **`2BTR9-XTEINKX4`** |
| Exhibit type | **Users Manual** |
| Exhibit title, as filed | Users Manual |
| FCC document id | 8956383 |
| Upstream publication date | 2026-07-04 |
...
- <https://fccid.io/2BTR9-XTEINKX4/User-Manual/Users-Manual-8956383.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=8956383>  
...
- <https://fcc.report/FCC-ID/2BTR9-XTEINKX4/8956383.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2BTR9-XTEINKX4/User-Manual/Users-Manual-8956383.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/devices/xteink/x4/artifacts/certification/2BTR9-XTEINKX4-users-manual.pdf" \
   "devices/xteink/x4/artifacts/certification/2BTR9-XTEINKX4-users-manual.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2BTR9-XTEINKX4/User-Manual/Users-Manual-8956383.pdf" -o "2BTR9-XTEINKX4-users-manual.pdf"
echo "7329a83131ad1ed913833316b6225415feee97392fabb240913db69e81b0c100  2BTR9-XTEINKX4-users-manual.pdf" | sha256sum -c -
```

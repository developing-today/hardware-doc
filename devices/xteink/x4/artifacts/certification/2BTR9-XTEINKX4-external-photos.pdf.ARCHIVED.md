# ARCHIVED: `2BTR9-XTEINKX4-external-photos.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — external photos, 381,099 B (0.36 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `devices/xteink/x4/artifacts/certification/2BTR9-XTEINKX4-external-photos.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/devices/xteink/x4/artifacts/certification/2BTR9-XTEINKX4-external-photos.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 381,099 B (0.36 MiB) |
| SHA-256 | `7bae5132f43bab0d4c2cc55e876b0974f4445b7d73ba7677219abca52d55e9bd` |
| FCC ID | **`2BTR9-XTEINKX4`** |
| Exhibit type | **External Photos** |
| Exhibit title, as filed | External Photos |
| FCC document id | 8956379 |
| Upstream publication date | 2026-01-05 |
| Grant date | 2026-01-05 |
| Equipment class | XTEINK X4, 2402-2480 MHz, 2412-2462 MHz |
...
- <https://fccid.io/2BTR9-XTEINKX4/External-Photos/External-Photos-8956379.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=8956379>  
...
- <https://fcc.report/FCC-ID/2BTR9-XTEINKX4/8956379.pdf>  
  fcc.report mirror. **403 to all five UAs tried on 2026-09-11.**

- <https://fccid.io/2BTR9-XTEINKX4>  
  the filing's exhibit index — re-read the row to recover a changed document slug.

- <https://web.archive.org/web/2/https://fccid.io/2BTR9-XTEINKX4/External-Photos/External-Photos-8956379.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/devices/xteink/x4/artifacts/certification/2BTR9-XTEINKX4-external-photos.pdf" \
   "devices/xteink/x4/artifacts/certification/2BTR9-XTEINKX4-external-photos.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2BTR9-XTEINKX4/External-Photos/External-Photos-8956379.pdf" -o "2BTR9-XTEINKX4-external-photos.pdf"
echo "7bae5132f43bab0d4c2cc55e876b0974f4445b7d73ba7677219abca52d55e9bd  2BTR9-XTEINKX4-external-photos.pdf" | sha256sum -c -
```

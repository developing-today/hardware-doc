# ARCHIVED: `2AN3WM5DINMETER-external-photos.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — external photos, 2,123,431 B (2.03 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `devices/m5stack/dinmeter/artifacts/certification/2AN3WM5DINMETER-external-photos.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/devices/m5stack/dinmeter/artifacts/certification/2AN3WM5DINMETER-external-photos.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 2,123,431 B (2.03 MiB) |
| SHA-256 | `b5aac335a6631663b90352c1edbc7926522235682d3b73c91db7731c2a0d5f0e` |
| FCC ID | **`2AN3WM5DINMETER`** |
| Exhibit type | **External Photos** |
| Exhibit title, as filed | External Photos |
| FCC document id | 7497872 |
...
- <https://fccid.io/2AN3WM5DINMETER/External-Photos/External-Photos-7497872.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=7497872>  
...
- <https://fcc.report/FCC-ID/2AN3WM5DINMETER/7497872.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2AN3WM5DINMETER/External-Photos/External-Photos-7497872.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/devices/m5stack/dinmeter/artifacts/certification/2AN3WM5DINMETER-external-photos.pdf" \
   "devices/m5stack/dinmeter/artifacts/certification/2AN3WM5DINMETER-external-photos.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2AN3WM5DINMETER/External-Photos/External-Photos-7497872.pdf" -o "2AN3WM5DINMETER-external-photos.pdf"
echo "b5aac335a6631663b90352c1edbc7926522235682d3b73c91db7731c2a0d5f0e  2AN3WM5DINMETER-external-photos.pdf" | sha256sum -c -
```

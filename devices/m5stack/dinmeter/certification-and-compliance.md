# Certification and compliance — dinmeter
...
The DinMeter is granted in its own right. The M5StampS3A module it carries has a separate grant.

| Regime | Status |
|---|---|
| **FCC (US)** | ✅ `2AN3WM5DINMETER` |
...
**Supporting / related grants:** `2AN3WM5STAMPS3A`.

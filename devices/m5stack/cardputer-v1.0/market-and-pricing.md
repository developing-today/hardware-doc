# Market and pricing — cardputer-v1.0
...
|---|---|---|---|---|---|
| [EOL] M5Stack Cardputer Kit w/ M5StampS3 | 2023-10-13 | Default Title | `K132` | **USD 23.90** | ❌ no |
| [EOL] Cardputer Accessory Kit (M5StampS3 + Display) | 2024-08-12 | Default Title | `A145` | **USD 9.95** | ❌ no |
...
> *USD 23.90, 1 unit, retrieved 2026-09-11, `https://shop.m5stack.com/products/m5stack-cardputer-kit-w-m5stamps3`, ships from Shenzhen, CN*

### Normalisation and caveats

`K132` is the **complete kit** (StampS3 + keyboard + shell); `A145` is the **accessory kit only** (no Stamp). ⚠ These are *not* comparable — one is a whole device at USD 23.90, the other a USD 9.95 parts bundle. Both are `[EOL]`, `available: false`.

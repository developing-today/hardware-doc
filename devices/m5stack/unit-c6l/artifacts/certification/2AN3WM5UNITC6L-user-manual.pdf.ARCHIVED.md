# ARCHIVED: `2AN3WM5UNITC6L-user-manual.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — users manual, 440,093 B (0.42 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `devices/m5stack/unit-c6l/artifacts/certification/2AN3WM5UNITC6L-user-manual.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/devices/m5stack/unit-c6l/artifacts/certification/2AN3WM5UNITC6L-user-manual.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 440,093 B (0.42 MiB) |
| SHA-256 | `c464ca0b385d85e3e280ac1684752a983dd0700a39cc102a8188bf49c99e8dae` |
| FCC ID | **`2AN3WM5UNITC6L`** |
| Exhibit type | **Users Manual** |
| Exhibit title, as filed | User Manual |
| FCC document id | 8610519 |
...
- <https://fccid.io/2AN3WM5UNITC6L/User-Manual/User-Manual-8610519.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=8610519>  
...
- <https://fcc.report/FCC-ID/2AN3WM5UNITC6L/8610519.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2AN3WM5UNITC6L/User-Manual/User-Manual-8610519.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/devices/m5stack/unit-c6l/artifacts/certification/2AN3WM5UNITC6L-user-manual.pdf" \
   "devices/m5stack/unit-c6l/artifacts/certification/2AN3WM5UNITC6L-user-manual.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2AN3WM5UNITC6L/User-Manual/User-Manual-8610519.pdf" -o "2AN3WM5UNITC6L-user-manual.pdf"
echo "c464ca0b385d85e3e280ac1684752a983dd0700a39cc102a8188bf49c99e8dae  2AN3WM5UNITC6L-user-manual.pdf" | sha256sum -c -
```

# Market and pricing — cap-lora868
...
⚠ **No product matching 'Cap LoRa868' exists in M5Stack's store.** All 13 `868`-matching products were inspected; every one is a LoRaWAN module or unit, **none is a Cardputer Cap**. See the certification record for the matching FCC absence.

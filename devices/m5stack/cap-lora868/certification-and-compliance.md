# Certification and compliance — cap-lora868
...
⚠ **No FCC grant found, and no such product in M5Stack's own store.** See §4. An 868 MHz part would not be sold into the US in any case — 868 MHz is the EU SRD band, not a US ISM band — so FCC absence is expected and uninformative here. The *store* absence is the notable half.

...
Held at `scratch/market-and-certification/fcc/2AN3WM5DINMETER/` (**unstaged**, 198 MB total for the pass). Reacquire with `https://fccid.io/2AN3WM5DINMETER/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).
...
Held at `scratch/market-and-certification/fcc/2AN3WM5STAMPS3A/` (**unstaged**, 198 MB total for the pass). Reacquire with `https://fccid.io/2AN3WM5STAMPS3A/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).

# Certification and compliance — dinmeter-v1.1
...
**No FCC ID specific to v1.1.** The only DinMeter grant is `2AN3WM5DINMETER` (2024-07-23), which pre-dates the v1.1 product listing (Shopify `published_at` 2026-01-30). Either v1.1 ships under the existing grant as a permissive change, or it is not separately authorised. **Not resolved here** — no Class II Permissive Change filing appears under `2AN3W`.
...
**Supporting / related grants:** `2AN3WM5DINMETER`, `2AN3WM5STAMPS3A`.
...
| Final action date | **2412-2462 MHz Original Equipment 2024-07-23** |
| Application purpose | Final Action Date 2412-2462 MHz Original Equipment 2024-07-23 |
...
| Filing page | `https://fccid.io/2AN3WM5DINMETER` — HTTP 200, retrieved 2026-09-11 |
...
|---|---|---|
| `External-Photos-External-Photos.pdf` | 2,123,431 | `b5aac335a6631663…` |
| `ID-Label-Location-Info-FCC-ID-Label.pdf` | 357,530 | `87bc3655794390cc…` |
| `Internal-Photos-Internal-Photos.pdf` | 3,674,683 | `7e0be459cbbf21a4…` |
| `RF-Exposure-Info-FCC-RF-Exposure-MPE.pdf` | 126,464 | `aeb323a16a2ad99c…` |
| `Test-Report-Antenna-Specification.pdf` | 822,846 | `0728acb7f328e39c…` |
| `Users-Manual-User-Manual.pdf` | 2,021,122 | `b472ab81821318a6…` |

Filed under this record's `artifacts/certification/` — ID-label and internal-photo exhibits retained in the repository, the rest archived with `.ARCHIVED.md` placeholders. The scratch copies at `scratch/market-and-certification/fcc/2AN3WM5DINMETER/` were **consolidated 2026-09-20** after every exhibit was re-hashed and matched byte-for-byte against its filed copy; only `_filing.html` remains there. Reacquire from upstream with `https://fccid.io/2AN3WM5DINMETER/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).
...
| Applicant | M5Stack Technology Co.,Ltd |
| Grantee code | `2AN3W` — registered 2017-10-23, 59 FCC IDs total |
| Final action date | **2402-2480 MHz Original Equipment 2025-02-13** |
| Application purpose | Final Action Date 2402-2480 MHz Original Equipment 2025-02-13 |
| Frequency ranges | **2402-2480 MHz** (BLE), **2412-2462 MHz** (Wi-Fi 2.4 GHz, US channels 1–11) |
| Test firm | Dongguan Yaxu (AiT) Technology Limited |
| Long-term confidentiality | Yes |
| Exhibit rows | 17 available, 3 metadata-only |
| Filing page | `https://fccid.io/2AN3WM5STAMPS3A` — HTTP 200, retrieved 2026-09-11 |
...
| Exhibit | Bytes | SHA-256 (first 16) |
|---|---|---|
| `External-Photos-External-Photos.pdf` | 2,142,184 | `6910fdc8e5f46913…` |
| `ID-Label-Location-Info-label-and-location.pdf` | 69,357 | `60d9ccb36cc10e2a…` |
| `Internal-Photos-Internal-Photos.pdf` | 2,778,287 | `e6512283b0e419c2…` |
| `RF-Exposure-Info-FCC-RF-Exposure-MPE-20cm-.pdf` | 176,710 | `db49d95ade5911cc…` |
| `Test-Report-AiTDG-241205002W1-Test-Report-BLE.pdf` | 959,274 | `027dd133c4ac00b6…` |
| `Users-Manual-User-Manual.pdf` | 2,308,121 | `e9056d899bdd6cda…` |

Filed under this record's `artifacts/certification/` — ID-label and internal-photo exhibits retained in the repository, the rest archived with `.ARCHIVED.md` placeholders. The scratch copies at `scratch/market-and-certification/fcc/2AN3WM5STAMPS3A/` were **consolidated 2026-09-20** after every exhibit was re-hashed and matched byte-for-byte against its filed copy; only `_filing.html` remains there. Reacquire from upstream with `https://fccid.io/2AN3WM5STAMPS3A/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).

# Certification and compliance — stamp-c6lora
...
| Final action date | **2412-2462 MHz Original Equipment 2025-11-19 902.3-914.9 MHz Original Equipment 2025-11-19** |
| Application purpose | Original Equipment |
| Frequency ranges | **2402-2480 MHz** (BLE), **2412-2462 MHz** (Wi-Fi 2.4 GHz, US channels 1–11), **902.3-914.9 MHz**, **903-914.2 MHz** |
| Test firm | Guangdong Asia Hongke Test Technology Limited |
| Long-term confidentiality | Yes |
| Exhibit rows | 19 available, 4 metadata-only |
| Filing page | `https://fccid.io/2AN3WM5STAMPC6LORA` — HTTP 200, retrieved 2026-09-11 |
...
|---|---|---|
| `External-Photos-EUT-External-photos.pdf` | 1,252,196 | `c1d9b24c18c383c7…` |
| `ID-Label-Location-Info-Label-location.pdf` | 199,647 | `c838daa020297b84…` |
| `Internal-Photos-EUT-Internal-photos.pdf` | 416,641 | `947b644d1a168f53…` |
| `RF-Exposure-Info-AiTSZ-250812012FW5_FCC-RF-EXPOSURE.pdf` | 449,566 | `00cfed2f15bf7bbf…` |
| `Test-Report-AiTSZ-250812012FW1_FCC-Test-Report_2.4G-WIFI.pdf` | 2,092,093 | `f04da403673dd3ba…` |
| `Users-Manual-User-manual.pdf` | 1,928,952 | `30447e175f34062a…` |

Filed under this record's `artifacts/certification/` — ID-label and internal-photo exhibits retained in the repository, the rest archived with `.ARCHIVED.md` placeholders. The scratch copies at `scratch/market-and-certification/fcc/2AN3WM5STAMPC6LORA/` were **consolidated 2026-09-20** after every exhibit was re-hashed and matched byte-for-byte against its filed copy; only `_filing.html` remains there. Reacquire from upstream with `https://fccid.io/2AN3WM5STAMPC6LORA/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).

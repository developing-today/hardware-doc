# ARCHIVED: `2AN3WM5PAPERMONO-user-manual.pdf`
...
**Reason:** bulk FCC exhibit — the FCC users manual. Its specification table and Arduino quick-start are transcribed in [`certification.md`](../../certification.md); the rest is screenshots of the Arduino IDE.
...
| Field | Value |
|---|---|
| Original repo path | `devices/m5stack/papermono/artifacts/certification/2AN3WM5PAPERMONO-user-manual.pdf` |
| Archived to | `archive/devices/m5stack/papermono/artifacts/certification/2AN3WM5PAPERMONO-user-manual.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 1,433,361 B (1.37 MiB) |
| SHA-256 | `c51b4c2ec4ca557a06b97e092970b360a13c3b2e49590d4cf5292bf8923bfdf0` |
| FCC ID | **`2AN3WM5PAPERMONO`** |
| Exhibit type | **Users Manual** |
| Exhibit title, as filed | User Manual |
| FCC document id | 9553004 |
...
- <https://fccid.io/2AN3WM5PAPERMONO/User-Manual/User-Manual-9553004.pdf>
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=9553004>
...
- <https://fcc.report/FCC-ID/2AN3WM5PAPERMONO/9553004.pdf>
...
- <https://web.archive.org/web/2/https://fccid.io/2AN3WM5PAPERMONO/User-Manual/User-Manual-9553004.pdf>
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one — run from the repository root:

```bash
mv "archive/devices/m5stack/papermono/artifacts/certification/2AN3WM5PAPERMONO-user-manual.pdf" \
   "devices/m5stack/papermono/artifacts/certification/2AN3WM5PAPERMONO-user-manual.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2AN3WM5PAPERMONO/User-Manual/User-Manual-9553004.pdf" -o "2AN3WM5PAPERMONO-user-manual.pdf"
echo "c51b4c2ec4ca557a06b97e092970b360a13c3b2e49590d4cf5292bf8923bfdf0  2AN3WM5PAPERMONO-user-manual.pdf" | sha256sum -c -
```

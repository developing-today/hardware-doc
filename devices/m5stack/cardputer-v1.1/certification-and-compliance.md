# Certification and compliance — cardputer-v1.1
...
No v1.1-specific grant. `2AN3WM5CARDPUTER` (2024-07-22) is the only non-ADV Cardputer filing.

| Regime | Status |
|---|---|
| **FCC (US)** | ✅ `2AN3WM5CARDPUTER` |
...
| Final action date | **2402-2480 MHz Original Equipment 2024-07-22** |
| Application purpose | Final Action Date 2402-2480 MHz Original Equipment 2024-07-22 |
...
| Filing page | `https://fccid.io/2AN3WM5CARDPUTER` — HTTP 200, retrieved 2026-09-11 |
...
|---|---|---|
| `External-Photos-External-Photos.pdf` | 1,811,474 | `daafa38179323ddb…` |
| `ID-Label-Location-Info-FCC-ID-Label.pdf` | 467,757 | `fcdfbce02de768d7…` |
| `Internal-Photos-Internal-Photos.pdf` | 1,588,902 | `04d0f83f4d202d9f…` |
| `RF-Exposure-Info-FCC-RF-Exposure-MPE.pdf` | 126,467 | `6c89ae08c922ccde…` |
| `Test-Report-Antenna-Specification.pdf` | 822,846 | `0728acb7f328e39c…` |
| `Users-Manual-User-Manual.pdf` | 3,165,025 | `629df489491ef940…` |

Filed under this record's `artifacts/certification/` — ID-label and internal-photo exhibits retained in the repository, the rest archived with `.ARCHIVED.md` placeholders. The scratch copies at `scratch/market-and-certification/fcc/2AN3WM5CARDPUTER/` were **consolidated 2026-09-20** after every exhibit was re-hashed and matched byte-for-byte against its filed copy; only `_filing.html` remains there. Reacquire from upstream with `https://fccid.io/2AN3WM5CARDPUTER/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).

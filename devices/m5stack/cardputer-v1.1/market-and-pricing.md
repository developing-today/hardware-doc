# Market and pricing — cardputer-v1.1
...
|---|---|---|---|---|---|
| [EOL] M5Stack Cardputer with M5StampS3 v1.1 | 2025-03-07 | Default Title | `K132-V11` | **USD 29.90** | ✅ yes |
| Cardputer Accessory Kit v1.1 (M5StampS3A + Display) | 2025-07-04 | Default Title | `A145-V033` | **USD 9.95** | ✅ yes |
...
> *USD 29.90, 1 unit, retrieved 2026-09-11, `https://shop.m5stack.com/products/m5stack-cardputer-with-m5stamps3-v1-1`, ships from Shenzhen, CN*

### Normalisation and caveats

`K132-V11` complete kit vs `A145-V033` accessory-only. **Normalised: the USD 29.90 figure is the complete kit.** ⚠ The kit is `[EOL]`-titled yet still `available: true` — the store's EOL tag and its stock flag disagree.

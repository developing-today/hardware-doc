# Market and pricing — cardputer-mesh-kit
...
|---|---|---|---|---|---|
| Cardputer Mesh Kit for Meshtastic (ESP32-S3) | 2026-04-30 | Default Title | `K152` | **USD 48.00** | ✅ yes |
...
> *USD 48.00, 1 unit, retrieved 2026-09-11, `https://shop.m5stack.com/products/cardputer-mesh-kit-for-meshtastic-esp32-s3`, ships from Shenzhen, CN*

### Normalisation and caveats

SKU `K152`. ⚠ **A bundle.** At USD 48.00 it sits above Cardputer ADV (29.90) + Cap LoRa 1262 (14.50) = **USD 44.40**, a USD 3.60 bundle premium. Do not merge this into a bare-board range.

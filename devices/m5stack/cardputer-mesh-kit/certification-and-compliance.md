...
Held at `scratch/market-and-certification/fcc/2AN3WM5CAPLORA1262/` (**unstaged**, 198 MB total for the pass). Reacquire with `https://fccid.io/2AN3WM5CAPLORA1262/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).

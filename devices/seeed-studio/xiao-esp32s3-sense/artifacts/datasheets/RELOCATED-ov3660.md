# RELOCATED: OV3660 datasheets

Superseded — see [`CAMERA-DATASHEETS-MOVED.md`](CAMERA-DATASHEETS-MOVED.md), which is the single
record covering **all** camera documents moved out of this directory (OV2640, OV3660, OV5640 and the
module specs).

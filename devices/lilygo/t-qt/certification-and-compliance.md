# Certification and compliance — t-qt
...
The grant is named 'T-QT Pro'. The store sells T-QT Pro and T-QT C6; **only the Pro is granted**.

| Regime | Status |
|---|---|
| **FCC (US)** | ✅ `2ASYE-T-QT-PRO` |
...
| Final action date | **2412-2472 MHz Original Equipment 2022-12-31** |
| Application purpose | Final Action Date 2412-2472 MHz Original Equipment 2022-12-31 |
...
| Exhibit rows | 10 available, 3 metadata-only |
| Filing page | `https://fccid.io/2ASYE-T-QT-PRO` — HTTP 200, retrieved 2026-09-11 |
...
|---|---|---|
| `External-Photos-External-Photos.pdf` | 199,661 | `a6424be9d8f42f8a…` |
| `ID-Label-Location-Info-E-Label-Information.pdf` | 791,402 | `0f023a387208fa1b…` |
| `Internal-Photos-Internal-Photos.pdf` | 1,899,930 | `eaa10d9bc4199d8a…` |
| `RF-Exposure-Info-RF-Exposure.pdf` | 186,288 | `d22c52193b7daeb6…` |

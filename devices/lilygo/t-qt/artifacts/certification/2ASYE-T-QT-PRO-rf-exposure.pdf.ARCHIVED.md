# ARCHIVED: `2ASYE-T-QT-PRO-rf-exposure.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — rf exposure info, 186,288 B (0.18 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `devices/lilygo/t-qt/artifacts/certification/2ASYE-T-QT-PRO-rf-exposure.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/devices/lilygo/t-qt/artifacts/certification/2ASYE-T-QT-PRO-rf-exposure.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 186,288 B (0.18 MiB) |
| SHA-256 | `d22c52193b7daeb66039f1980f72e38f486522d39dec3b179cd135ad24d2777f` |
| FCC ID | **`2ASYE-T-QT-PRO`** |
| Exhibit type | **RF Exposure Info** |
| Exhibit title, as filed | RF Exposure |
| FCC document id | 6304974 |
...
- <https://fccid.io/2ASYE-T-QT-PRO/RF-Exposure-Info/RF-Exposure-6304974.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=6304974>  
...
- <https://fcc.report/FCC-ID/2ASYE-T-QT-PRO/6304974.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2ASYE-T-QT-PRO/RF-Exposure-Info/RF-Exposure-6304974.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/devices/lilygo/t-qt/artifacts/certification/2ASYE-T-QT-PRO-rf-exposure.pdf" \
   "devices/lilygo/t-qt/artifacts/certification/2ASYE-T-QT-PRO-rf-exposure.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2ASYE-T-QT-PRO/RF-Exposure-Info/RF-Exposure-6304974.pdf" -o "2ASYE-T-QT-PRO-rf-exposure.pdf"
echo "d22c52193b7daeb66039f1980f72e38f486522d39dec3b179cd135ad24d2777f  2ASYE-T-QT-PRO-rf-exposure.pdf" | sha256sum -c -
```

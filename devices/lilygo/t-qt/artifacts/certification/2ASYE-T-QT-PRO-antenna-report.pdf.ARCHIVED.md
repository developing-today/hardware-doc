# ARCHIVED: `2ASYE-T-QT-PRO-antenna-report.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — test report, 667,906 B (0.64 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `devices/lilygo/t-qt/artifacts/certification/2ASYE-T-QT-PRO-antenna-report.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/devices/lilygo/t-qt/artifacts/certification/2ASYE-T-QT-PRO-antenna-report.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 667,906 B (0.64 MiB) |
| SHA-256 | `9feb27607d52592982ea3645db1285c9be73c79884442a7140e9346317f5a181` |
| FCC ID | **`2ASYE-T-QT-PRO`** |
| Exhibit type | **Test Report** |
| Exhibit title, as filed | Antenna Report |
| FCC document id | 6304972 |
...
- <https://fccid.io/2ASYE-T-QT-PRO/Test-Report/Antenna-Report-6304972.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=6304972>  
...
- <https://fcc.report/FCC-ID/2ASYE-T-QT-PRO/6304972.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2ASYE-T-QT-PRO/Test-Report/Antenna-Report-6304972.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/devices/lilygo/t-qt/artifacts/certification/2ASYE-T-QT-PRO-antenna-report.pdf" \
   "devices/lilygo/t-qt/artifacts/certification/2ASYE-T-QT-PRO-antenna-report.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2ASYE-T-QT-PRO/Test-Report/Antenna-Report-6304972.pdf" -o "2ASYE-T-QT-PRO-antenna-report.pdf"
echo "9feb27607d52592982ea3645db1285c9be73c79884442a7140e9346317f5a181  2ASYE-T-QT-PRO-antenna-report.pdf" | sha256sum -c -
```

# ARCHIVED: `2ASYE-T4-S3-241-user-manual.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — users manual, 1,308,927 B (1.25 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `devices/lilygo/t4-s3/artifacts/certification/2ASYE-T4-S3-241-user-manual.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/devices/lilygo/t4-s3/artifacts/certification/2ASYE-T4-S3-241-user-manual.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 1,308,927 B (1.25 MiB) |
| SHA-256 | `392e0deb78d4e31dbfe2159ccad86d02706b9faf9e0435224c6001e517a6cca0` |
| FCC ID | **`2ASYE-T4-S3-241`** |
| Exhibit type | **Users Manual** |
| Exhibit title, as filed | User Manual |
| FCC document id | 7140048 |
...
- <https://fccid.io/2ASYE-T4-S3-241/User-Manual/User-Manual-7140048.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=7140048>  
...
- <https://fcc.report/FCC-ID/2ASYE-T4-S3-241/7140048.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2ASYE-T4-S3-241/User-Manual/User-Manual-7140048.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/devices/lilygo/t4-s3/artifacts/certification/2ASYE-T4-S3-241-user-manual.pdf" \
   "devices/lilygo/t4-s3/artifacts/certification/2ASYE-T4-S3-241-user-manual.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2ASYE-T4-S3-241/User-Manual/User-Manual-7140048.pdf" -o "2ASYE-T4-S3-241-user-manual.pdf"
echo "392e0deb78d4e31dbfe2159ccad86d02706b9faf9e0435224c6001e517a6cca0  2ASYE-T4-S3-241-user-manual.pdf" | sha256sum -c -
```

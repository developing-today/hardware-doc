# Certification and compliance — t-display-s3-amoled-plus
...
⚠ No grant names 'AMOLED Plus'. The store lists it as 1.9 inch, which *may* place it under `2ASYE-T-DISPLAY-19` ('AMOLED 1.91'). **Inferred from the panel size alone; not confirmed.**
...
**Supporting / related grants:** `2ASYE-T-DISPLAY-19`.

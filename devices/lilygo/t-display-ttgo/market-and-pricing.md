# Market and pricing — t-display-ttgo
...
|---|---|---|---|---|---|
| T-Display | 2023-08-04 | 4MB [Q224] | `Q224` | **USD 8.04** | ✅ yes |
| T-Display | 2023-08-04 | 16MB [Q125] | `Q125` | **USD 8.94** | ✅ yes |
| T-Display | 2023-08-04 | 4MB With Shell [K163] | `K163` | **USD 11.99** | ✅ yes |
| T-Display | 2023-08-04 | 16MB With Shell Soldered [K198] | `K198` | **USD 12.99** | ❌ no |
| T-Display | 2023-08-04 | 16MB With Shell Non-Soldered [K164] | `K164` | **USD 12.99** | ✅ yes |
| T-Display Case | 2022-08-19 | T-Display Case [L925] | `L925` | **USD 2.17** | ✅ yes |
...
> *USD 8.04, 1 unit, retrieved 2026-09-11, `https://www.lilygo.cc/products/t-display`, ships from Shenzhen, CN*

### Normalisation and caveats

The original ESP32 T-Display: 4 MB USD 8.04, 16 MB USD 8.94, with shell USD 11.99–12.99. Case alone USD 2.17. **Still in stock in 2026** — an unusually long life for this class of board.

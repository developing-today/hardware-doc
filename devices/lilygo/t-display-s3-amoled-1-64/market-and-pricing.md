# Market and pricing — t-display-s3-amoled-1-64
...
The store calls this handle **'T-Display S3 AMOLED (DS)'** and sells four panel sizes under it: 1.64″ USD 22.99, 1.43″ USD 23.99, 1.75″ USD 27.86, 1.75″ convex-mirror USD 30.25. ⚠ This repo splits the same store handle across **two** device records — see the note below.

# Certification and compliance — t-display-s3-amoled-1-64
...
⚠ **No grant names the 1.43″/1.64″/1.75″ sizes.** The two AMOLED grants name 'T-Display-S3-AMOLED' and '1.91'. Whether the DS-series sizes ride on either grant is **unresolved**.
...
**Supporting / related grants:** `2ASYE-TDISS3-AMOLED`, `2ASYE-T-DISPLAY-19`.

# Certification and compliance — t-display-s3-pro
...
| Final action date | **2402-2480 MHz Original Equipment 2024-03-27** |
| Application purpose | Final Action Date 2402-2480 MHz Original Equipment 2024-03-27 |
...
| Exhibit rows | 20 available, 3 metadata-only |
| Filing page | `https://fccid.io/2ASYE-T-DISPLAY-PRO` — HTTP 200, retrieved 2026-09-11 |
...
|---|---|---|
| `External-Photos-External-Photos-1.pdf` | 5,534,909 | `cf8db3e26ae5a115…` |
| `External-Photos-External-Photos-2.pdf` | 5,737,973 | `ca357899424b5787…` |
| `ID-Label-Location-Info-ID-Label-Location-Info-1.pdf` | 309,287 | `44c20ebf6a73ad6b…` |
| `ID-Label-Location-Info-ID-Label-Location-Info-2.pdf` | 227,798 | `76d12dffc2889435…` |
| `Internal-Photos-Internal-Photos.pdf` | 4,541,201 | `9624956bf203111d…` |
| `RF-Exposure-Info-RF-Exposure-Info-1.pdf` | 100,255 | `63235ef32237eae4…` |
| `RF-Exposure-Info-RF-Exposure-Info-2.pdf` | 100,231 | `621b801a871d4d99…` |
| `Test-Report-ANT-Test-Report.pdf` | 1,177,730 | `635fa5a26234c5ba…` |
| `Users-Manual-Users-Manual.pdf` | 938,620 | `1e4c731fadac5111…` |

Filed under this record's `artifacts/certification/` — ID-label and internal-photo exhibits retained in the repository, the rest archived with `.ARCHIVED.md` placeholders. The scratch copies at `scratch/market-and-certification/fcc/2ASYE-T-DISPLAY-PRO/` were **consolidated 2026-09-20** after every exhibit was re-hashed and matched byte-for-byte against its filed copy; only `_filing.html` remains there. Reacquire from upstream with `https://fccid.io/2ASYE-T-DISPLAY-PRO/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).

# Market and pricing — t-display-s3-touch
...
Touch variants of the shared `t-display-s3` handle: `H587` non-soldered USD 12.61, `H589` soldered USD 13.02 — a **USD 3.57 premium** over the equivalent non-touch board.

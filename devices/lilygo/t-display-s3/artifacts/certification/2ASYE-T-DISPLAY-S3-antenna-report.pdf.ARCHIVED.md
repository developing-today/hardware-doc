# ARCHIVED: `2ASYE-T-DISPLAY-S3-antenna-report.pdf`

> This file was **moved out of the repository**, not deleted.
> Archived **2026-09-11** by the round-2 index merge.

**Reason:** bulk FCC exhibit — test report, 1,054,223 B (1.01 MiB). The round-2 artifact split keeps internal photographs and ID-label exhibits in the repository (they are the identification and teardown evidence) and archives the full test reports, RF-exposure annexes, users manuals and external-photo sets, which are bulky and repetitive.

## Identity

| Field | Value |
|---|---|
| Original repo path | `devices/lilygo/t-display-s3/artifacts/certification/2ASYE-T-DISPLAY-S3-antenna-report.pdf` |
| Archived to | `/home/user/repo-archive/hardware-doc/devices/lilygo/t-display-s3/artifacts/certification/2ASYE-T-DISPLAY-S3-antenna-report.pdf` |
| Type | file (PDF, magic-byte validated `%PDF`) |
| Size | 1,054,223 B (1.01 MiB) |
| SHA-256 | `45b9998b58613e2b69ba1478a665fb71f5d9fa40824f104fd5f44bf5ea73fae9` |
| FCC ID | **`2ASYE-T-DISPLAY-S3`** |
| Exhibit type | **Test Report** |
| Exhibit title, as filed | Antenna Report |
| FCC document id | 6272040 |
...
- <https://fccid.io/2ASYE-T-DISPLAY-S3/Test-Report/Antenna-Report-6272040.pdf>  
...
- <https://apps.fcc.gov/eas/GetApplicationAttachment.html?id=6272040>  
...
- <https://fcc.report/FCC-ID/2ASYE-T-DISPLAY-S3/6272040.pdf>  
...
- <https://web.archive.org/web/2/https://fccid.io/2ASYE-T-DISPLAY-S3/Test-Report/Antenna-Report-6272040.pdf>  
  Wayback Machine, if every live route is dead.

Restore from the local archive, if you have one:

```bash
mv "/home/user/repo-archive/hardware-doc/devices/lilygo/t-display-s3/artifacts/certification/2ASYE-T-DISPLAY-S3-antenna-report.pdf" \
   "devices/lilygo/t-display-s3/artifacts/certification/2ASYE-T-DISPLAY-S3-antenna-report.pdf"
```

Or re-download and verify — note the User-Agent, which is not optional:

```bash
curl -fsSL -A "curl/8.5.0" "https://fccid.io/2ASYE-T-DISPLAY-S3/Test-Report/Antenna-Report-6272040.pdf" -o "2ASYE-T-DISPLAY-S3-antenna-report.pdf"
echo "45b9998b58613e2b69ba1478a665fb71f5d9fa40824f104fd5f44bf5ea73fae9  2ASYE-T-DISPLAY-S3-antenna-report.pdf" | sha256sum -c -
```

...
Held at `scratch/market-and-certification/fcc/2ASYE-T-DISPLAY-S3/` (**unstaged**, 198 MB total for the pass). Reacquire with `https://fccid.io/2ASYE-T-DISPLAY-S3/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).

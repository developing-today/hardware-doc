# Certification and compliance — t-display-s3
...
The board carries an ESP32-S3-WROOM-1 module, itself FCC-granted under Espressif's `2AC7Z`.

| Regime | Status |
|---|---|
| **FCC (US)** | ✅ `2ASYE-T-DISPLAY-S3` |

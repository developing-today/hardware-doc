# Certification and compliance — t-display-s3-long
...
| Final action date | **2412-2462 MHz Original Equipment 2024-02-23** |
| Application purpose | Final Action Date 2412-2462 MHz Original Equipment 2024-02-23 |
...
| Filing page | `https://fccid.io/2ASYE-TDISPLAY-LONG` — HTTP 200, retrieved 2026-09-11 |
...
|---|---|---|
| `External-Photos-External-Photos.pdf` | 722,944 | `e80c1246ae6b9101…` |
| `ID-Label-Location-Info-Label-Label-Location.pdf` | 452,588 | `973a0b07e1fc10c9…` |
| `Internal-Photos-Internal-Photos.pdf` | 1,074,668 | `6655935bdc86a8ee…` |
| `RF-Exposure-Info-RF-Exposure---BLE.pdf` | 169,460 | `6af1e686fa63f85b…` |
| `RF-Exposure-Info-RF-Exposure---Wi-Fi.pdf` | 146,111 | `9239093c56bccf47…` |
| `Test-Report-Antenna-Specification.pdf` | 1,174,923 | `a1300af9d0563dac…` |
| `Users-Manual-User-Manual.pdf` | 1,187,373 | `a3d949a545df696e…` |

Filed under this record's `artifacts/certification/` — ID-label and internal-photo exhibits retained in the repository, the rest archived with `.ARCHIVED.md` placeholders. The scratch copies at `scratch/market-and-certification/fcc/2ASYE-TDISPLAY-LONG/` were **consolidated 2026-09-20** after every exhibit was re-hashed and matched byte-for-byte against its filed copy; only `_filing.html` remains there. Reacquire from upstream with `https://fccid.io/2ASYE-TDISPLAY-LONG/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).

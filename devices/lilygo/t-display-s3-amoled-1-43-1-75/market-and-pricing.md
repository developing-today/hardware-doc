# Market and pricing — t-display-s3-amoled-1-43-1-75
...
|---|---|---|---|---|---|
| T-Display S3 AMOLED (DS) | 2024-07-18 | 1.75 inch Half Circle Convex Mirror [H741-02] | `H741-02` | **USD 30.25** | ✅ yes |
| T-Display S3 AMOLED (DS) | 2024-07-18 | 1.75 inch [H741-01] | `H741-01` | **USD 27.86** | ✅ yes |
| T-Display S3 AMOLED (DS) | 2024-07-18 | 1.43 inch [H741] | `H741` | **USD 23.99** | ✅ yes |
| T-Display S3 AMOLED (DS) | 2024-07-18 | 1.64 inch [H708] | `H708` | **USD 22.99** | ✅ yes |
...
> *USD 30.25, 1 unit, retrieved 2026-09-11, `https://www.lilygo.cc/products/t-display-s3-amoled-1-64`, ships from Shenzhen, CN*

### Normalisation and caveats

⚠ **Same store handle as `t-display-s3-amoled-1-64`.** The 1.43″ (USD 23.99) and 1.75″ (USD 27.86 / 30.25 convex) variants live under the handle named for the 1.64″. **This repo's two records map onto one storefront product**; that is a repo-side split, not a vendor one.

# Certification and compliance — t-display-s3-pro-mvsrboard
...
An add-on board for the T-Display-S3 Pro; no independent grant, and none expected.
...
**Supporting / related grants:** `2ASYE-T-DISPLAY-PRO`.

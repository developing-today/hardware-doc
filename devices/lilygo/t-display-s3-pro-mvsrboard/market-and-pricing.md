# Market and pricing — t-display-s3-pro-mvsrboard
...
Within the `t-display-s3-pro` handle: `H751` **MVSR board alone** USD 10.20; `K255`/`K255-01` mainboard **with** MVSR board USD 42.33.

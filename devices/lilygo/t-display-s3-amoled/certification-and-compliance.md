# Certification and compliance — t-display-s3-amoled
...
**FCC: granted.** 2 filing(s) apply directly.

Two grants plausibly apply: `2ASYE-TDISS3-AMOLED` (2025-03-17, 'T-Display-S3-AMOLED') and `2ASYE-T-DISPLAY-19` (2024-03-21, 'T-Display-S3 AMOLED 1.91'). **Which covers which store variant is not established** — see §4.

| Regime | Status |
|---|---|
| **FCC (US)** | ✅ `2ASYE-TDISS3-AMOLED`, `2ASYE-T-DISPLAY-19` |
...
| Final action date | **2402-2480 MHz Original Equipment 2025-03-17** |
| Application purpose | Final Action Date 2402-2480 MHz Original Equipment 2025-03-17 |
...
| Exhibit rows | 16 available, 3 metadata-only |
| Filing page | `https://fccid.io/2ASYE-TDISS3-AMOLED` — HTTP 200, retrieved 2026-09-11 |
...
|---|---|---|
| `External-Photos-External-Photos.pdf` | 1,797,931 | `28026191703ef5d5…` |
| `ID-Label-Location-Info-E-Label.pdf` | 1,132,948 | `b59d8d92acbbc8f9…` |
| `Internal-Photos-Internal-Photos.pdf` | 1,830,747 | `042a30c69f0e1175…` |
| `RF-Exposure-Info-RF-Exposure.pdf` | 152,844 | `8c40576dcdf810a5…` |
| `Test-Report-Antenna-Specification.pdf` | 1,444,723 | `ff7b49a25f654d63…` |
| `Users-Manual-User-Manual.pdf` | 2,753,493 | `d4106c5cc334ca45…` |

Filed under this record's `artifacts/certification/` — ID-label and internal-photo exhibits retained in the repository, the rest archived with `.ARCHIVED.md` placeholders. The scratch copies at `scratch/market-and-certification/fcc/2ASYE-TDISS3-AMOLED/` were **consolidated 2026-09-20** after every exhibit was re-hashed and matched byte-for-byte against its filed copy; only `_filing.html` remains there. Reacquire from upstream with `https://fccid.io/2ASYE-TDISS3-AMOLED/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).
...
| Applicant | Shenzhen Xin Yuan Electronic Technology Co., Ltd. (LilyGO) |
| Grantee code | `2ASYE` — registered 2019-04-05, 33 FCC IDs total |
| Final action date | **2402-2480 MHz Original Equipment 2024-03-21** |
| Application purpose | Final Action Date 2402-2480 MHz Original Equipment 2024-03-21 |
...
| Long-term confidentiality | Yes |
| Exhibit rows | 15 available, 3 metadata-only |
| Filing page | `https://fccid.io/2ASYE-T-DISPLAY-19` — HTTP 200, retrieved 2026-09-11 |
...
| Exhibit | Bytes | SHA-256 (first 16) |
|---|---|---|
| `External-Photos-External-Photos.pdf` | 805,031 | `c4d77ec49971c832…` |
| `ID-Label-Location-Info-ID-Label-Location-Info.pdf` | 546,549 | `e50584b3ca7fa52b…` |
| `Internal-Photos-Internal-Photos.pdf` | 763,922 | `bb73f298bb8eec10…` |
| `RF-Exposure-Info-RF-Exposure-Info.pdf` | 146,095 | `0d98c024a6d1a029…` |
| `Test-Report-ATN-Test-Report.pdf` | 1,174,923 | `a1300af9d0563dac…` |
| `Users-Manual-Users-Manual.pdf` | 1,068,816 | `97096597308fdd0e…` |

Filed under this record's `artifacts/certification/` — ID-label and internal-photo exhibits retained in the repository, the rest archived with `.ARCHIVED.md` placeholders. The scratch copies at `scratch/market-and-certification/fcc/2ASYE-T-DISPLAY-19/` were **consolidated 2026-09-20** after every exhibit was re-hashed and matched byte-for-byte against its filed copy; only `_filing.html` remains there. Reacquire from upstream with `https://fccid.io/2ASYE-T-DISPLAY-19/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).
...
Filed under this record's `artifacts/certification/` — ID-label and internal-photo exhibits retained in the repository, the rest archived with `.ARCHIVED.md` placeholders. The scratch copies at `scratch/market-and-certification/fcc/2AC7Z-ESPS3WROOM1/` were **consolidated 2026-09-20** after every exhibit was re-hashed and matched byte-for-byte against its filed copy; only `_filing.html` remains there. Reacquire from upstream with `https://fccid.io/2AC7Z-ESPS3WROOM1/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).

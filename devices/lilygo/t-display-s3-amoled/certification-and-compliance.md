...
Held at `scratch/market-and-certification/fcc/2ASYE-TDISS3-AMOLED/` (**unstaged**, 198 MB total for the pass). Reacquire with `https://fccid.io/2ASYE-TDISS3-AMOLED/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).
...
Held at `scratch/market-and-certification/fcc/2ASYE-T-DISPLAY-19/` (**unstaged**, 198 MB total for the pass). Reacquire with `https://fccid.io/2ASYE-T-DISPLAY-19/<Type-Slug>/<Doc-Slug>.pdf` and a `curl` UA — see [the method guide](../../../guides/research/finding-certification-records.md).

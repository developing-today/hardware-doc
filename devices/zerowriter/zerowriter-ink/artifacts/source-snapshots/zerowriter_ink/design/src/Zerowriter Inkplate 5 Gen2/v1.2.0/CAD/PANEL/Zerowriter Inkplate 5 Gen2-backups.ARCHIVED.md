# ARCHIVED: `Zerowriter Inkplate 5 Gen2-backups/`
...
| Archived to | `scratch/zerowriter-provenance-2026-08-30/upstream/zerowriter_ink-996207aca0677300ed5f1fdf762d9c9ec79f516e/design/src/Zerowriter Inkplate 5 Gen2/v1.2.0/CAD/PANEL/Zerowriter Inkplate 5 Gen2-backups` |
| Type | directory of ZIP archives |
| Size | **18449694 B** |
| File count | **7** ZIP files |
| Extracted-tree digest (`LC_ALL=C`) | `6b42f1da305f87e974d8835416e194fea9aa15fa8a3643a13078042e1ed46f03` |
...
| Path within upstream repo | `design/src/Zerowriter Inkplate 5 Gen2/v1.2.0/CAD/PANEL/Zerowriter Inkplate 5 Gen2-backups` |
...
|---|---:|---|---|
| `Zerowriter Inkplate 5 Gen2-2025-07-23_101610.zip` | 2831210 | 2026-05-13 | `7dfbcb60acd21818d6fad9608f3e2d972a0e92b07e63d094c6cf03b247a0e7ca` |
| `Zerowriter Inkplate 5 Gen2-2025-07-23_102638.zip` | 2833733 | 2026-05-13 | `71790f0f8a9534bd5ebac895304a6502efca1923d5aec14f353d4360e865c875` |
| `Zerowriter Inkplate 5 Gen2-2025-07-23_103837.zip` | 2839703 | 2026-05-13 | `2f19f034f2154ac25b585902b33848738506728944a15f87ed43411252b9098f` |
| `Zerowriter Inkplate 5 Gen2-2025-07-23_121623.zip` | 1422185 | 2026-05-13 | `818151460778cf43a476b8729ecfd885ac289b4602ec5133fc2f2d699e80360e` |
| `Zerowriter Inkplate 5 Gen2-2025-07-24_074517.zip` | 2841139 | 2026-05-13 | `b6d2f692b193bbe02137791ed3557babc6af0d4fb22b9c406390076a8774f194` |
| `Zerowriter Inkplate 5 Gen2-2025-07-24_080119.zip` | 2841151 | 2026-05-13 | `0d81a33c0aeeea9d597909dce8bc0dcdcedfa2ea0eaa9b3ec1851aeaeb792330` |
| `Zerowriter Inkplate 5 Gen2-2025-07-24_081103.zip` | 2840573 | 2026-05-13 | `08c1d2b7544812c5f00bc5bc3f04ec6d7602e0dbaec0fa0a59064f19e56b9bfa` |
...
> `archive/devices/zerowriter/zerowriter-ink/artifacts/source-snapshots/zerowriter_ink/design/src/Zerowriter Inkplate 5 Gen2/v1.2.0/CAD/PANEL/Zerowriter Inkplate 5 Gen2-backups`.
...
#   -> "design/src/Zerowriter Inkplate 5 Gen2/v1.2.0/CAD/PANEL/Zerowriter Inkplate 5 Gen2-backups"
...
find "Zerowriter Inkplate 5 Gen2-backups" -type f | wc -l                                      # 7
find "Zerowriter Inkplate 5 Gen2-backups" -type f -printf '%s\n' | awk '{s+=$1}END{print s}'    # 18449694
find "Zerowriter Inkplate 5 Gen2-backups" -type f -exec sha256sum {} + | LC_ALL=C sort -k2 | sha256sum
#   6b42f1da305f87e974d8835416e194fea9aa15fa8a3643a13078042e1ed46f03
```
...
```bash
mv "$HOME/hardware-doc-archive/devices/zerowriter/zerowriter-ink/artifacts/source-snapshots/zerowriter_ink/design/src/Zerowriter Inkplate 5 Gen2/v1.2.0/CAD/PANEL/Zerowriter Inkplate 5 Gen2-backups" \
   "devices/zerowriter/zerowriter-ink/artifacts/source-snapshots/zerowriter_ink/design/src/Zerowriter Inkplate 5 Gen2/v1.2.0/CAD/PANEL/Zerowriter Inkplate 5 Gen2-backups"
```
